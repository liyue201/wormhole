...
export interface NodePrivilegedService {
  ...
  SendObservationRequest(
    request: DeepPartial<SendObservationRequestRequest>,
    metadata?: grpc.Metadata
  ): Promise<SendObservationRequestResponse>;
}
...
export class NodePrivilegedServiceClientImpl implements NodePrivilegedService {
  ...
  SendObservationRequest(
    ...
    return this.rpc.unary(
      NodePrivilegedServiceSendObservationRequestDesc,
      SendObservationRequestRequest.fromPartial(request),
      metadata
    );
  }
}
...
export const NodePrivilegedServiceSendObservationRequestDesc: UnaryMethodDefinitionish =
  {
    ...
    responseType: {
      deserializeBinary(data: Uint8Array) {
        return {
          ...SendObservationRequestResponse.decode(data),
          toObject() {
            return this;
          },
        };
