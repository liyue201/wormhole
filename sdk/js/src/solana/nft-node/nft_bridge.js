...
module.exports.transfer_native_ix = function(program_id, bridge_id, payer, message, from, mint, nonce, target_address, target_chain) {
    ...
    const ptr6 = passArray8ToWasm0(target_address, wasm.__wbindgen_malloc);
    const len6 = WASM_VECTOR_LEN;
    const ret = wasm.transfer_native_ix(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, nonce, ptr6, len6, target_chain);
...
module.exports.transfer_wrapped_ix = function(program_id, bridge_id, payer, message, from, from_owner, token_chain, token_address, token_id, nonce, target_address, target_chain) {
    ...
    const len6 = WASM_VECTOR_LEN;
    const ptr7 = passArray8ToWasm0(token_id, wasm.__wbindgen_malloc);
    const len7 = WASM_VECTOR_LEN;
    const ptr8 = passArray8ToWasm0(target_address, wasm.__wbindgen_malloc);
    const len8 = WASM_VECTOR_LEN;
    const ret = wasm.transfer_wrapped_ix(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, token_chain, ptr6, len6, ptr7, len7, nonce, ptr8, len8, target_chain);
    return takeObject(ret);
};
...
module.exports.complete_transfer_native_ix = function(program_id, bridge_id, payer, to_authority, vaa) {
    ...
    const ptr2 = passStringToWasm0(payer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(to_authority, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
...
module.exports.complete_transfer_wrapped_meta_ix = function(program_id, bridge_id, payer, vaa) {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.complete_transfer_wrapped_meta_ix(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    return takeObject(ret);
};
...
module.exports.wrapped_address = function(program_id, token_address, token_chain, token_id) {
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(token_id, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
...
module.exports.spl_meta_address = function(mint_address) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(mint_address, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
const path = require('path').join(__dirname, 'nft_bridge_bg.wasm');
