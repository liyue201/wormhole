...
interface MockBridgeImplementationInterface extends ethers.utils.Interface {
  functions: {
    ...
    "completeTransferAndUnwrapETHWithPayload(bytes,address)": FunctionFragment;
    "completeTransferWithPayload(bytes,address)": FunctionFragment;
    ...
    "transferTokensWithPayload(address,uint256,uint16,bytes32,uint256,uint32,bytes)": FunctionFragment;
    ...
    "wrapAndTransferETHWithPayload(uint16,bytes32,uint256,uint32,bytes)": FunctionFragment;
