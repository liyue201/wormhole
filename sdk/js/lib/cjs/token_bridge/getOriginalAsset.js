...
exports.getOriginalAssetAlgorand = exports.getOriginalAssetSol = exports.getOriginalAssetTerra = exports.getOriginalAssetEth = void 0;
...
function getOriginalAssetTerra(client, wrappedAddress) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (terra_1.isNativeDenom(wrappedAddress)) {
                        return [2 /*return*/, {
                                isWrapped: false,
                                chainId: utils_2.CHAIN_ID_TERRA,
                                assetAddress: terra_1.buildNativeId(wrappedAddress),
                            }];
                    }
                    _a.label = 1;
                case 1:
                ...
                case 4: return [2 /*return*/, {
                        isWrapped: false,
                        chainId: utils_2.CHAIN_ID_TERRA,
                        assetAddress: utils_1.zeroPad(terra_1.canonicalAddress(wrappedAddress), 32),
                    }];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = retVal;
                    return [4 /*yield*/, getIsWrappedAsset_1.getIsWrappedAssetAlgorand(client, tokenBridgeId, assetId)];
                case 1:
                    _a.isWrapped = _b.sent();
                    if (!retVal.isWrapped) {
                        retVal.assetAddress = utils_1.zeroPad(utils_2.hexToUint8Array(assetId.toString(16)), 32);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, algorand_1.decodeLocalState(client, tokenBridgeId, lsa)];
                case 3:
                    dls = _b.sent();
