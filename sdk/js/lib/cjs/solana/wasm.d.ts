...
export declare function importTokenWasm(): Promise<{
    ...
    transfer_native_with_payload_ix(program_id: string, bridge_id: string, payer: string, message: string, from: string, mint: string, nonce: number, amount: BigInt, fee: BigInt, target_address: Uint8Array, target_chain: number, payload: Uint8Array): any;
    ...
    transfer_wrapped_with_payload_ix(program_id: string, bridge_id: string, payer: string, message: string, from: string, from_owner: string, token_chain: number, token_address: Uint8Array, nonce: number, amount: BigInt, fee: BigInt, target_address: Uint8Array, target_chain: number, payload: Uint8Array): any;
