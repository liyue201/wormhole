...
exports.postVaa = exports.createPostVaaInstruction = exports.createVerifySignaturesInstructions = exports.postVaaWithRetry = void 0;
var web3_js_1 = require("@solana/web3.js");
var __1 = require("..");
var solana_1 = require("../utils/solana");
var rust_1 = require("./rust");
var wasm_1 = require("./wasm");
function postVaaWithRetry(connection, signTransaction, bridge_id, payer, vaa, maxRetries) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    batchableChunks = __1.chunks(instructions, 2);
                    batchableChunks.forEach(function (chunk) {
                        var transaction;
                        if (chunk.length === 1) {
                            transaction = new web3_js_1.Transaction().add(chunk[0]);
                        }
                        else {
                            transaction = new web3_js_1.Transaction().add(chunk[0], chunk[1]);
                        }
                        unsignedTransactions.push(transaction);
                    });
                    finalTransaction = new web3_js_1.Transaction().add(finalInstruction);
                    partialSignWrapper = function (transaction) {
                        transaction.partialSign(signature_set);
                        return signTransaction(transaction);
                    };
                    return [4 /*yield*/, solana_1.sendAndConfirmTransactionsWithRetry(connection, partialSignWrapper, payer, unsignedTransactions, maxRetries)];
                case 3:
                    _a.sent();
                    //While the signature_set is used to create the final instruction, it doesn't need to sign it.
                    return [4 /*yield*/, solana_1.sendAndConfirmTransactionsWithRetry(connection, signTransaction, payer, [finalTransaction], maxRetries)];
                case 4:
                    //While the signature_set is used to create the final instruction, it doesn't need to sign it.
                    _a.sent();
...
*/
function createVerifySignaturesInstructions(connection, bridge_id, payer, vaa, signature_set) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    output = [];
                    return [4 /*yield*/, wasm_1.importCoreWasm()];
                case 1:
                    ...
                    guardian_addr = new web3_js_1.PublicKey(guardian_set_address(bridge_id, guardian_set_index));
...
*/
function createPostVaaInstruction(bridge_id, payer, vaa, signatureSetKeypair) {
    return __awaiter(this, void 0, void 0, function () {
        var post_vaa_ix;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, rust_1.ixFromRust(post_vaa_ix(bridge_id, payer, signatureSetKeypair.publicKey.toString(), vaa))];
            }
        });
    });
}
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    transaction_1 = (_c = new web3_js_1.Transaction()).add.apply(_c, __spreadArray([], __read(ixs)));
