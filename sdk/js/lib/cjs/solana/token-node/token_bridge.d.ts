...
export function complete_transfer_native_ix(program_id: string, bridge_id: string, payer: string, vaa: Uint8Array, fee_recipient: string | undefined): any;
export function complete_transfer_wrapped_ix(program_id: string, bridge_id: string, payer: string, vaa: Uint8Array, fee_recipient: string | undefined): any;
...
export function custody_signer(program_id: string): Uint8Array;
