...
function _parseVAAAlgorand(vaa) {
    ...
    if (vaa.slice(off).length === 100 && buf.readIntBE(off, 1) === 2) {
        ...
        off += 1;
        ret.set("Contract", utils_2.uint8ArrayToHex(extract3(vaa, off, 32)));
        off += 32;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    seq = parsedVAA.get("sequence") / BigInt(exports.MAX_BITS);
                ...
                case 4:
                    params = _c.sent();
                    digest = utils_1.keccak256(utils_1.keccak256(parsedVAA.get("digest"))).slice(2);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!(parsedVAA.get("FromChain") !== utils_2.CHAIN_ID_ALGORAND)) return [3 /*break*/, 5];
                ...
                case 11:
                    ...
                    foreignAssets = [];
                    a = 0;
                    if (!(parsedVAA.get("FromChain") !== utils_2.CHAIN_ID_ALGORAND)) return [3 /*break*/, 13];
                    return [4 /*yield*/, decodeLocalState(client, tokenBridgeId, chainAddr)];
                case 12:
                    asset = _b.sent();
                    if (asset.length > 8) {
                ...
                case 14:
                    ...
                    if ((parsedVAA.get("ToChain") === 8) && (parsedVAA.get("Type") === 3)) {
                        ...
                        addr = algosdk_1.encodeAddress(utils_2.hexToUint8Array(parsedVAA.get("ToAddress")));
                    }
