...
export const InjectGovernanceVAAResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.digests.push(reader.bytes() as Buffer);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): InjectGovernanceVAAResponse {
    ...
    if (object.digests !== undefined && object.digests !== null) {
      for (const e of object.digests) {
        message.digests.push(Buffer.from(bytesFromBase64(e)));
      }
    }
    return message;
  },
...
export const FindMissingMessagesRequest = {
  encode(
    ...
    for (const v of message.backfillNodes) {
  ...
  fromJSON(object: any): FindMissingMessagesRequest {
    ...
    if (object.backfillNodes !== undefined && object.backfillNodes !== null) {
      for (const e of object.backfillNodes) {
  ...
  toJSON(message: FindMissingMessagesRequest): unknown {
    ...
    if (message.backfillNodes) {
      obj.backfillNodes = message.backfillNodes.map((e) => e);
    } else {
      obj.backfillNodes = [];
    }
    return obj;
...
const baseSendObservationRequestRequest: object = {};

export const SendObservationRequestRequest = {
  encode(
    message: SendObservationRequestRequest,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.observationRequest !== undefined) {
      ObservationRequest.encode(
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSendObservationRequestRequest,
    } as SendObservationRequestRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.observationRequest = ObservationRequest.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): SendObservationRequestRequest {
    ...
    if (
      ...
      message.observationRequest = ObservationRequest.fromJSON(
  ...
  fromPartial(
    object: DeepPartial<SendObservationRequestRequest>
  ): SendObservationRequestRequest {
    const message = {
      ...baseSendObservationRequestRequest,
    } as SendObservationRequestRequest;
    if (
      ...
      message.observationRequest = ObservationRequest.fromPartial(
        object.observationRequest
      );
    } else {
      message.observationRequest = undefined;
...
const baseSendObservationRequestResponse: object = {};

export const SendObservationRequestResponse = {
  encode(
    _: SendObservationRequestResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSendObservationRequestResponse,
    } as SendObservationRequestResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<SendObservationRequestResponse>
  ): SendObservationRequestResponse {
    const message = {
      ...baseSendObservationRequestResponse,
    } as SendObservationRequestResponse;
 ...
 */
export const NodePrivilegedServiceService = {
  /**
   ...
   */
  injectGovernanceVAA: {
    path: "/node.v1.NodePrivilegedService/InjectGovernanceVAA",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: InjectGovernanceVAARequest) =>
      Buffer.from(InjectGovernanceVAARequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      InjectGovernanceVAARequest.decode(value),
    responseSerialize: (value: InjectGovernanceVAAResponse) =>
      Buffer.from(InjectGovernanceVAAResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      InjectGovernanceVAAResponse.decode(value),
  },
  /**
   ...
   */
  findMissingMessages: {
    path: "/node.v1.NodePrivilegedService/FindMissingMessages",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: FindMissingMessagesRequest) =>
      Buffer.from(FindMissingMessagesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      FindMissingMessagesRequest.decode(value),
    responseSerialize: (value: FindMissingMessagesResponse) =>
      Buffer.from(FindMissingMessagesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      FindMissingMessagesResponse.decode(value),
  },
  /**
  ...
  sendObservationRequest: {
    path: "/node.v1.NodePrivilegedService/SendObservationRequest",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SendObservationRequestRequest) =>
      Buffer.from(SendObservationRequestRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      SendObservationRequestRequest.decode(value),
    responseSerialize: (value: SendObservationRequestResponse) =>
      Buffer.from(SendObservationRequestResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      SendObservationRequestResponse.decode(value),
  },
} as const;

export interface NodePrivilegedServiceServer
   ...
   * VAA timeout window for it to reach consensus.
   */
  injectGovernanceVAA: handleUnaryCall<
    InjectGovernanceVAARequest,
    InjectGovernanceVAAResponse
  >;
  /**
   ...
   * An error is returned if more than 1000 gaps are found.
   */
  findMissingMessages: handleUnaryCall<
    FindMissingMessagesRequest,
    FindMissingMessagesResponse
  >;
  /**
   ...
   * Requests at higher rates will fail silently.
   */
  sendObservationRequest: handleUnaryCall<
    SendObservationRequestRequest,
    SendObservationRequestResponse
  >;
}
...
export interface NodePrivilegedServiceClient extends Client {
  ...
  injectGovernanceVAA(
    ...
    callback: (
      ...
      response: InjectGovernanceVAAResponse
    ) => void
  ): ClientUnaryCall;
  injectGovernanceVAA(
    request: InjectGovernanceVAARequest,
   ...
   */
  findMissingMessages(
    request: FindMissingMessagesRequest,
    callback: (
      error: ServiceError | null,
      response: FindMissingMessagesResponse
    ) => void
  ): ClientUnaryCall;
  findMissingMessages(
    request: FindMissingMessagesRequest,
   ...
   */
  sendObservationRequest(
    request: SendObservationRequestRequest,
    callback: (
      error: ServiceError | null,
      response: SendObservationRequestResponse
    ) => void
  ): ClientUnaryCall;
  sendObservationRequest(
    request: SendObservationRequestRequest,
...
export const NodePrivilegedServiceClient = makeGenericClientConstructor(
  NodePrivilegedServiceService,
  "node.v1.NodePrivilegedService"
) as unknown as {
  new (
    address: string,
    credentials: ChannelCredentials,
    options?: Partial<ChannelOptions>
  ): NodePrivilegedServiceClient;
};
