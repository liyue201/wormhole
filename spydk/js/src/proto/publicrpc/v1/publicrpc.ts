...
export const PublicRPCServiceService = {
  /**
  ...
  getLastHeartbeats: {
    ...
    requestSerialize: (value: GetLastHeartbeatsRequest) =>
      Buffer.from(GetLastHeartbeatsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      GetLastHeartbeatsRequest.decode(value),
    responseSerialize: (value: GetLastHeartbeatsResponse) =>
      Buffer.from(GetLastHeartbeatsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      GetLastHeartbeatsResponse.decode(value),
  },
  getSignedVAA: {
    path: "/publicrpc.v1.PublicRPCService/GetSignedVAA",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetSignedVAARequest) =>
      Buffer.from(GetSignedVAARequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetSignedVAARequest.decode(value),
    responseSerialize: (value: GetSignedVAAResponse) =>
      Buffer.from(GetSignedVAAResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetSignedVAAResponse.decode(value),
  },
  getCurrentGuardianSet: {
    path: "/publicrpc.v1.PublicRPCService/GetCurrentGuardianSet",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetCurrentGuardianSetRequest) =>
      Buffer.from(GetCurrentGuardianSetRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      GetCurrentGuardianSetRequest.decode(value),
    responseSerialize: (value: GetCurrentGuardianSetResponse) =>
      Buffer.from(GetCurrentGuardianSetResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      GetCurrentGuardianSetResponse.decode(value),
  },
} as const;
...
export interface PublicRPCServiceServer extends UntypedServiceImplementation {
   ...
   * The heartbeat value is null if no heartbeat has yet been received.
   */
  getLastHeartbeats: handleUnaryCall<
    GetLastHeartbeatsRequest,
    GetLastHeartbeatsResponse
  >;
  getSignedVAA: handleUnaryCall<GetSignedVAARequest, GetSignedVAAResponse>;
  getCurrentGuardianSet: handleUnaryCall<
    GetCurrentGuardianSetRequest,
    GetCurrentGuardianSetResponse
  >;
}
...
export interface PublicRPCServiceClient extends Client {
   ...
   */
  getLastHeartbeats(
    request: GetLastHeartbeatsRequest,
    callback: (
      error: ServiceError | null,
      response: GetLastHeartbeatsResponse
    ) => void
  ): ClientUnaryCall;
  getLastHeartbeats(
    request: GetLastHeartbeatsRequest,
  ...
  getSignedVAA(
    request: GetSignedVAARequest,
    callback: (
      error: ServiceError | null,
      response: GetSignedVAAResponse
    ) => void
  ): ClientUnaryCall;
  getSignedVAA(
    request: GetSignedVAARequest,
  ...
  getCurrentGuardianSet(
    request: GetCurrentGuardianSetRequest,
    callback: (
      error: ServiceError | null,
      response: GetCurrentGuardianSetResponse
    ) => void
  ): ClientUnaryCall;
  getCurrentGuardianSet(
    request: GetCurrentGuardianSetRequest,
...
export const PublicRPCServiceClient = makeGenericClientConstructor(
  PublicRPCServiceService,
  "publicrpc.v1.PublicRPCService"
) as unknown as {
  new (
    address: string,
