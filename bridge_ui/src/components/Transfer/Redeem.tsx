...
function Redeem() {
  ...
  const isBasNative =
      targetChain === CHAIN_ID_BAS &&
      targetAsset &&
      targetAsset.toLowerCase() === WOVR_ADDRESS.toLowerCase();
  const isFindoraNative =
      targetChain === CHAIN_ID_FINDORA &&
      targetAsset &&
      targetAsset.toLowerCase() === WFRA_ADDRESS.toLowerCase();
